        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:gap-3">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 px-4 py-2 rounded-lg transition-colors shadow-sm">Register</a>
                @endauth
            </div>
        ...
        <div class="pt-4 pb-3 border-t border-gray-100 px-3">
            ...
            @else
                <div class="space-y-0.5 mt-2">
                    <a href="{{ route('login') }}" class="block px-3 py-2.5 rounded-md text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50">Log in</a>
                    <a href="{{ route('register') }}" class="block px-3 py-2.5 rounded-md text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50">Register</a>
                </div>
            @endauth
        </div>
    </div>
