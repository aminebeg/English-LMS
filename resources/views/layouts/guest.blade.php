...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen grid lg:grid-cols-2">
            ...
            <div class="hidden lg:flex relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 overflow-hidden">
                <!-- Decorative Background Elements -->
                <div class="absolute inset-0 opacity-10">
                    <div class="absolute top-0 -left-4 w-96 h-96 bg-white rounded-full mix-blend-overlay filter blur-3xl animate-blob"></div>
                    <div class="absolute top-0 -right-4 w-96 h-96 bg-white rounded-full mix-blend-overlay filter blur-3xl animate-blob animation-delay-2000"></div>
                    <div class="absolute -bottom-8 left-20 w-96 h-96 bg-white rounded-full mix-blend-overlay filter blur-3xl animate-blob animation-delay-4000"></div>
                </div>
                ...
                <div class="relative z-10 flex flex-col justify-between p-12 w-full">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-indigo-100 text-sm">Learn from qualified tutors with proven teaching methods</p>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-white/20">
                        <p class="text-white/90 italic text-sm">"The journey of a thousand miles begins with a single step."</p>
