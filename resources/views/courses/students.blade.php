<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('courses.edit', $course) }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                {{ __('Back to Course') }}
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap align-middle">
                                                ...
                                                <span class="text-xs text-gray-500 dark:text-gray-400 mt-1 inline-block">{{ $student->progress }}%</span>
                                            </td>
                    ...
                    @else
                        <div class="text-center py-10">
                            <p class="text-gray-500 dark:text-gray-400">No students enrolled in this course yet.</p>
                        </div>
                    @endif
                </div>
            </div>
