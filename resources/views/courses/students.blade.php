    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('courses.edit', $course) }}"
                class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 hover:bg-gray-600 transition-colors">
                {{ __('Back to Course') }}
            </a>
        </div>
    </x-slot>
                                    ...
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap align-middle">
                                                ...
                                                <span
                                                    class="text-xs text-gray-500 mt-1 inline-block">{{ $student->progress }}%</span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <form
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="text-red-600 hover:text-red-900 hover:text-red-300">
                                                        Remove
                                                    </button>
                                                </form>
                                            </td>
