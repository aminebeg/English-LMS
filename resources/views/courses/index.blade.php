        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between mb-8">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-700 text-gray-400">A list of all the courses you are teaching.</p>
                </div>
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="flex-shrink-0 h-10 w-16 bg-gray-100 bg-gray-800 rounded overflow-hidden">
                                                            @if($course->thumbnail)
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex flex-col gap-1">
                                                        @if($course->is_published)
                                                            <span class="inline-flex px-2 text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 bg-green-900 text-green-200 w-fit">
                                                                Published
                                                            </span>
                                                        @else
                                                            <span class="inline-flex px-2 text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800 bg-gray-700 text-gray-300 w-fit">
                                                                Draft
                                                            </span>
                                                        @endif
                                                        
                                                        @if($course->is_featured)
                                                            <span class="inline-flex px-2 text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800 bg-yellow-900 text-yellow-200 w-fit">
                                                                Featured
                                                            </span>
                                                        @endif
                                                    </div>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="{{ route('courses.show', $course) }}" class="text-indigo-600 hover:text-indigo-900 text-indigo-400 hover:text-indigo-300 mr-4">View</a>
                                                    <a href="{{ route('courses.edit', $course) }}" class="text-indigo-600 hover:text-indigo-900 text-indigo-400 hover:text-indigo-300">Edit</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
