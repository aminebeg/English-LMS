    ...
    <div class="min-h-screen bg-gray-50 py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-lg text-gray-600">Fill in the details below to create your course. You can add lessons and materials after creation.</p>
            </div>

            <!-- Main Form Card -->
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-200">
                <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data" class="divide-y divide-gray-200 divide-gray-700">
                    @csrf

                    <!-- Basic Information Section -->
                    <div class="p-8 space-y-6">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="flex items-center justify-center w-10 h-10 rounded-xl bg-indigo-100 bg-indigo-900">
                                <svg class="w-6 h-6 text-indigo-600 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="block w-full px-4 py-3 rounded-xl border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 sm:text-base bg-gray-900 text-white transition-all duration-200"
                            >
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select 
                                        ...
                                        id="category" 
                                        required
                                        class="block w-full px-4 py-3 rounded-xl border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 sm:text-base bg-gray-900 text-white appearance-none transition-all duration-200"
                                    >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">Use CEFR levels for language courses, or general levels for other subjects</p>
                    ...
                    <div class="p-8 space-y-6 bg-gray-50/50">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="flex items-center justify-center w-10 h-10 rounded-xl bg-green-100 bg-green-900">
                                <svg class="w-6 h-6 text-green-600 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    required
                                    placeholder="0.00"
                                    class="block w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-300 shadow-sm focus:border-green-500 focus:ring-4 focus:ring-green-500/20 sm:text-base bg-gray-900 text-white transition-all duration-200"
                                >
                            </div>
                    ...
                    <!-- Actions -->
                    <div class="p-8 bg-gray-50 bg-gray-800/50 flex items-center justify-between gap-4">
                        <a href="{{ route('courses.index') }}" class="inline-flex items-center gap-2 px-6 py-3 text-base font-semibold text-gray-700 hover:text-gray-900 hover:text-white transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Help Text -->
            <div class="mt-8 p-6 bg-blue-50 bg-blue-900/20 border border-blue-200 border-blue-800 rounded-xl">
                <div class="flex gap-4">
                    <div class="flex-shrink-0">
                        <svg class="w-6 h-6 text-blue-600 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-sm font-bold text-blue-900 text-blue-100 mb-1">What happens next?</h3>
                        <p class="text-sm text-blue-800 text-blue-200">After creating your course, you'll be able to add lessons, upload materials, create tests, and publish when ready. Students can only enroll once the course is published.</p>
                    </div>
                </div>
            </div>
        </div>
