<x-guest-layout>
    <form method="POST" action="{{ route('tutor.register') }}">
        ...
        <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            <h3 class="font-semibold text-blue-900 dark:text-blue-100 mb-2">Become a Tutor</h3>
            <p class="text-sm text-blue-700 dark:text-blue-300">Join our platform as an English language tutor. Your application will be reviewed by our editorial team.</p>
        </div>
        ...
        <div class="mt-4">
            ...
            <p class="text-xs text-gray-500 mt-1">Tell us about your teaching experience and qualifications.</p>
