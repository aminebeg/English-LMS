<x-guest-layout>
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('tutor.register') }}" class="space-y-5">
            ...
            <!-- Info Box -->
            <div class="p-4 bg-indigo-50 bg-indigo-900/20 border-2 border-indigo-100 border-indigo-800 rounded-lg flex gap-3">
                <div class="flex-shrink-0">
                    <svg class="h-6 w-6 text-indigo-600 text-indigo-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
                    </svg>
                </div>
                <p class="text-sm font-medium text-indigo-800 text-indigo-200">
            ...
            <div>
                ...
                <textarea id="bio" name="bio" rows="4" class="block mt-2 w-full px-4 py-3 border-2 border-gray-300 bg-white text-gray-900 text-gray-100 placeholder-gray-400 placeholder-gray-500 rounded-lg shadow-sm focus:border-indigo-500 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/20 focus:ring-indigo-400/20 transition-all duration-200" placeholder="Tell us about your teaching experience and qualifications...">{{ old('bio') }}</textarea>
