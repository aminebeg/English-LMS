        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Adding content to <span
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="summary" id="summary" rows="2" placeholder="Brief overview..."
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-white border-gray-300 text-gray-900">{{ old('summary') }}</textarea>
                                </div>
                    ...
                    <div class="col-span-12 lg:col-span-4 space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pt-4 border-t border-gray-100">
                                    ...
                                    <select name="course_section_id" id="course_section_id"
                                        ...
                                        @foreach ($course->sections as $section)
                                            <option value="{{ $section->id }}" {{ (old('course_section_id') ?? request('course_section_id')) == $section->id ? 'selected' : '' }}>{{ $section->title }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="pt-4 border-t border-gray-100">
                                    ...
                                    <input type="number" name="order" id="order"
                                        value="{{ $course->lessons->count() + 1 }}" required min="1"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-white border-gray-300 text-gray-900">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                            ...
                            <textarea name="notes" id="notes" rows="4" placeholder="Private notes..."
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-white border-gray-300 text-gray-900">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
            </form>
