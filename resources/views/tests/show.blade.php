        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
                    <a href="{{ route('courses.show', $test->course) }}" class="hover:text-indigo-600 dark:hover:text-indigo-400">{{ $test->course->title }}</a>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    <span class="text-gray-900 dark:text-white font-medium">{{ $test->title }}</span>
                </div>
                
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{{ $test->title }}</h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $test->questions->count() }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $test->passing_score }}%</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white capitalize">{{ str_replace('_', ' ', $test->type ?? 'Quiz') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">#{{ $test->order }}</p>
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $test->questions->count() }} question(s) in this test</p>
                        </div>
                                    ...
                                    <div x-show="showAiModal" 
                                        ...
                                        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Generate with AI</h3>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Create questions automatically</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="px-6 py-5 space-y-4">
                                            <!-- API Key Warning -->
                                            <div x-show="!hasApiKey" class="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                                                <div class="flex items-start gap-3">
                                                    <svg class="w-5 h-5 text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                                                    </svg>
                                                    <div>
                                                        <h4 class="font-medium text-amber-800 dark:text-amber-300">API Key Required</h4>
                                                        <p class="text-sm text-amber-700 dark:text-amber-400 mt-1">You need to configure your Cerebras API key to use AI generation.</p>
                                                        <a href="{{ route('profile.edit') }}" class="inline-flex items-center gap-1 mt-2 text-sm font-medium text-amber-800 dark:text-amber-300 hover:underline">
                                            ...
                                            <!-- Error Message -->
                                            <div x-show="errorMessage" x-cloak class="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                                                <div class="flex items-start gap-3">
                                                    <svg class="w-5 h-5 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                    </svg>
                                                    <div>
                                                        <h4 class="font-medium text-red-800 dark:text-red-300">Generation Error</h4>
                                                        <p class="text-sm text-red-700 dark:text-red-400 mt-1" x-text="errorMessage"></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div x-show="hasApiKey">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" x-model="topic" id="topic" 
                                                        class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white focus:border-purple-500 focus:ring-purple-500 shadow-sm" 
                                                        placeholder="e.g. Past Simple Tense, Vocabulary, Grammar">
                                                </div>
                                                <div>
                                                    <label for="count" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Number of Questions</label>
                                                    <input type="number" x-model="count" id="count" min="1" max="10" 
                                                        class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white focus:border-purple-500 focus:ring-purple-500 shadow-sm">
                                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Maximum 10 questions per generation</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($test->questions->sortBy('order') as $question)
                        <div class="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                            <div class="flex items-start gap-4">
                                <!-- Question Number -->
                                <div class="flex-shrink-0 w-10 h-10 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center">
                                    <span class="text-sm font-bold text-indigo-600 dark:text-indigo-400">{{ $question->order }}</span>
                                </div>
                                
                                <!-- Question Content -->
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-start justify-between gap-4 mb-3">
                                        <p class="text-gray-900 dark:text-white font-medium">{{ $question->content }}</p>
                                    ...
                                    <div class="flex items-center gap-2 mb-3">
                                        @if($question->type === 'multiple_choice')
                                            <span class="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-medium rounded-md">
                                        ...
                                        @elseif($question->type === 'true_false')
                                            <span class="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 text-xs font-medium rounded-md">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                </svg>
                                                True / False
                                        ...
                                        @else
                                            <span class="inline-flex items-center gap-1 px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 text-xs font-medium rounded-md">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                                </svg>
                                                Short Answer
                                    ...
                                    @if($question->type === 'multiple_choice' && $question->options)
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            @foreach($question->options as $index => $option)
                                                <div class="flex items-center gap-2 px-3 py-2 rounded-lg {{ $option === $question->correct_answer ? 'bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800' : 'bg-gray-50 dark:bg-gray-700/50' }}">
                                                    <span class="flex-shrink-0 w-6 h-6 rounded-full {{ $option === $question->correct_answer ? 'bg-emerald-500 text-white' : 'bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-300' }} flex items-center justify-center text-xs font-bold">
                                                        {{ chr(65 + $index) }}
                                                    </span>
                                                    <span class="{{ $option === $question->correct_answer ? 'text-emerald-700 dark:text-emerald-300 font-medium' : 'text-gray-600 dark:text-gray-400' }} text-sm">
                                                        {{ $option }}
                                                    </span>
                                    ...
                                    @else
                                        <div class="inline-flex items-center gap-2 px-3 py-2 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg">
                                            <svg class="w-4 h-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                            <span class="text-sm text-emerald-700 dark:text-emerald-300 font-medium">{{ $question->correct_answer }}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="p-12 text-center">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 mb-6">Add questions to make this test available to students.</p>
