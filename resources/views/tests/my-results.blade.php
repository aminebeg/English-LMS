                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @if($results->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No Tests Taken Yet</h3>
                            <p class="text-gray-500 dark:text-gray-400 mb-6">You haven't taken any tests yet. Start learning to unlock tests!</p>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700/50">
                                    <tr>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Test</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($results as $result)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="text-sm font-bold {{ $result->passed ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                                    {{ $result->score }}%
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('tests.result', $result) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                                    View Details
                                                </a>
                                            </td>
                                        </tr>
